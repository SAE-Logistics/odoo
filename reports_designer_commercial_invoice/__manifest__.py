...

{
    ...
    'summary': 'Commercial Invoice (XLSX)',     
    'price': 0.00,
    'currency': 'EUR',
    "license": "OPL-1",     
    'description': """
Commercial Invoice (XLSX)
====================================
Commercial Invoice in MS Excel format (XLSX)
...
Report for Report Designer (XLSX, XLSM). 
    ...
    Report Designer Report Designer Report Builder Reports Builder Product Report Customer Report POS Reports POS Report Analysis Report \
    ...
    'depends': ['account','delivery','sale','stock'],
    'images': ['static/description/banner_rep.png'],
    'data': [
        'data/commercial_invoice_xlsx.xml',
        'data/commercial_invoice_xlsx_goods_orders.xml',
        'data/commercial_invoice_xlsx_transport_orders.xml',
    ],
    'qweb': [
    ],
    'demo': [],
